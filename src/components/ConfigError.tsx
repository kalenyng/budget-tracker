  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 dark:from-primary/20 via-gray-50 dark:via-gray-900 to-primary/5 dark:to-primary/10 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="glass rounded-3xl p-8 shadow-2xl border border-red-200 dark:border-red-800">
          ...
          <div className="space-y-4 text-sm text-gray-600 dark:text-gray-400">
            <p>
              Supabase environment variables are missing. Please create a <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-gray-900 dark:text-gray-100">.env</code> file in the project root with:
            </p>
            
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg font-mono text-xs text-gray-900 dark:text-gray-100">
