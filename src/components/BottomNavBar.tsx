...
export function BottomNavBar({ onOpenSettings }: BottomNavBarProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 safe-area-bottom bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg border-t border-gray-200 dark:border-gray-700 shadow-lg shadow-black/5">
      <div className="flex items-center justify-around h-16 px-2">
        ...
        <button
          ...
          className={cn(
            'relative flex flex-col items-center justify-center flex-1 h-full transition-colors text-gray-400 dark:text-gray-500'
          )}
        >
          <motion.div
            whileTap={{ scale: 0.9 }}
